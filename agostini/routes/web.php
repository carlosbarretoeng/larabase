...
Route::middleware([
    ...
    Route::middleware(['role:super-administrador'])->prefix('system')->group(function () {
        ...
        Route::resource('/motivosdeparada', App\Http\Controllers\MotivosDeParadaController::class)->names('motivosdeparada');
    });

    Route::middleware(['role:super-administrador|administrador'])->prefix('system')->group(function () {
        Route::resource('/departamentos', App\Http\Controllers\DepartamentosController::class)->names('departamentos');
    });
});
